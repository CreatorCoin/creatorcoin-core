...
[wiki](https://github.com/creatorcoins/creatorcoins-core/wiki).
...
To build after all dependencies are installed:
    ...
    git clone https://github.com/creatorcoins/creatorcoins-core.git
    cd creatorcoins-core
...
[here](https://github.com/creatorcoins/creatorcoins-core/blob/master/libraries/wallet/include/graphene/wallet/wallet.hpp).
...
about API's for the [witness node](https://creatorcoins.github.io/doxygen/namespacegraphene_1_1app.html) and the
[wallet](https://creatorcoins.github.io/doxygen/classgraphene_1_1wallet_1_1wallet__api.html).
If you want information which is not available from an API, it might be available
from the [database](https://creatorcoins.github.io/doxygen/classgraphene_1_1chain_1_1database.html);
...
- What is the meaning of `a.b.c` numbers?
    ...
    [types.hpp](https://github.com/creatorcoins/creatorcoins-2/blob/creatorcoins/libraries/chain/include/graphene/chain/protocol/types.hpp).
...
- The answer to the previous question was really confusing.  Can you make it clearer?
    ...
    your asset's ID will be `1.3.29`.  Asset `0` is special (it's CREA, which is considered the "core asset").
